...
- **Rerun:** `python3 scripts/run_bars_study_clean.py` (crypto), `run_equities_bars.py` (equities),
  ...
  Raw inputs come from the data roots configured in `config.py` (crypto perpetual 1m, HistData FX 1m,
  Algoseek ETF 1-minute); no market data is bundled in this repository (see `DATA.md`).
